  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        ...
        // Assuming URLs are in format: https://res.cloudinary.com/cloud-name/image/upload/v1234567890/folder/public-id.jpg
        ...
        <div className="md:col-span-2">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Modifiez les détails de base du produit.</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card className="mt-4">
            <CardHeader>
              ...
              <CardDescription>Modifiez les tailles et options d'encadrement pour ce produit.</CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <div className="space-y-4">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Modifiez les images pour ce produit.</CardDescription>
            </CardHeader>
            <CardContent>
